  ...
  return (
    <div>
      <Container className='containerAbout'>
        ...
        <Row className='contactRow' style={{ backgroundImage: `url(${Maps})` }}>
          <Col></Col>
          <Col className='contactDetail'>
            <div className='detail'>
              ...
              <div className='program'>
                ...
                <p className='program1'> Luni: închis</p>
                <p className='program2'> Marți - Duminică: 12:00 - 21:30</p>
              </div>
            </div>
          </Col>
        </Row>
